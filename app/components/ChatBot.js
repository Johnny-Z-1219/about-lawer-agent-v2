...
const ChatBot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      type: 'bot',
      content: '您好！我是董律师的智能助手，很高兴为您服务。我可以为您提供基础的法律咨询和解答。请问有什么法律问题需要帮助吗？',
      timestamp: new Date()
    }
  ]);
  ...
  const getAIResponse = (userMessage) => {
    ...
    // 常见法律问题的自动回复
    const responses = {
      '合同': '关于合同问题，我需要了解更多详情。一般来说，合同纠纷主要涉及：\n\n1. 合同的有效性\n2. 合同条款的解释\n3. 违约责任的认定\n4. 损失的计算\n\n建议您详细描述具体情况，或直接预约董律师进行专业咨询。',
      
      '离婚': '离婚案件涉及的主要问题包括：\n\n1. 夫妻共同财产分割\n2. 子女抚养权归属\n3. 抚养费标准\n4. 债务承担\n\n每个案件情况不同，建议您带齐相关材料，预约董律师面谈，以获得最专业的法律建议。',
    ...
    // 默认回复
    return '感谢您的咨询。您的问题我已经记录，建议您：\n\n1. 准备相关材料和证据\n2. 预约董律师面谈\n3. 详细描述具体情况\n\n董律师会为您提供专业的法律分析和解决方案。您可以通过电话0566-5021766或邮箱2548365492@qq.com预约咨询。';
  };
      ...
      <div className="bg-blue-600 text-white p-4 rounded-t-lg flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <div className="text-xs text-blue-100">安徽修实律师事务所</div>
          </div>
        </div>
        <button
